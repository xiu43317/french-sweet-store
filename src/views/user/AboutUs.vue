<template>
  <div class="container" style="overflow-x: hidden;">
    ...
    <div class="row mt-3">
      ...
      <div class="col-12 col-lg-6" data-aos="fade-left" data-aos-duration="1000" data-aos-once="false">
        <h3 class="mt-lg-0 fs-3 mt-3">羅傑創店的緣由</h3>
        <hr />
        <p class="fs-4">
